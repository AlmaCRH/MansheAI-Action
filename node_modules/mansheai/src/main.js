...
const getGitDiffAsync = async ({ octokit, githubUser, githubRepo }) => {
  try {
...
const runMansheAI = async ({githubToken, aikey, githubUser, githubRepo }) => {
  const octokit = new Octokit({ auth: githubToken });
  console.log("El token de github:", githubToken)
